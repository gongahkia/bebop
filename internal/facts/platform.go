...
var platformPolicies = []PlatformPolicy{
	...
	policy("raspberry-pi-os", "Raspberry Pi OS", "raspberry-pi-os", "raspbian", "", "", "", "", "", "", []string{"amd64", "arm64"}, nil, "apt", "dpkg", InitSystemSystemd, ReleaseFixed, AutomaticUpdatesSupported, RootPersistenceStandard, false, ""),
